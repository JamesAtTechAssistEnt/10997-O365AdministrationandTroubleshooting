...
Now, we will create a user using the following:

	6.1 Select  **Add a user**.

	6.2 On the  **Set up the basics** page, in the **First name** text box, enter **Lindsey**.

	6.3 In the  **Last name** text box, enter **Gates**.

	6.4 Notice that the  **Display name** text box is automatically filled in as **Lindsey Gates**.

	6.5 In the  **User name** text box, enter **Lindsey**.

	6.6 Verify that  ***Customdomainname.hostdomain.com*** is listed in the text box after the at sign (@), as your unique domain name. Ensure that **Auto-generate password** is selected as well as an option to require the user to change their password when they first sign in.

	6.7 Select **Next**.

	6.8 On the **Assign product licenses page**, in the **Select location** drop-down list, select your country/region. If your country/region is not listed, select **United States**.  In the **Licenses** section, ensure that Office 365 E5 is selected and select **Next**.

	6.9 On the **Optional settings** page, review available options, but don't make any changes. Select **Next**.

	6.10 On the  **Review and finish** page, review configured settings and select **Finish adding**. 

	6.11 On the **Lindsey Gates has been added** page, note the temporary password here: _______________ and select **Close**.

7. Repeat previous create a user steps to create the following users (for the  **User name**, use the  **First name**):
...
3. In the Exchange admin center, in the navigation pane, select  **Recipients**. Your users are listed under the **Mailboxes** section.

4. In the navigation pane, select  **organization**. Review the settings.

5. In the navigation pane, select  **Roles** then **Admin roles**.
...
11. To license Tameka Reed, at the command prompt, enter the following command, where ***Customdomainname.hostdomain.com*** is your unique domain; and select Enter. Replace ***Adatumyyxxxx*** in the **-AddLicenses** attribute with your unique domain name prefix:
